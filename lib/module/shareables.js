...
Offending code was: \`${getWorkletCode(value)}\``);
      ...
      const adapted = ReanimatedModule.makeShareableClone(toAdapt, shouldPersistRemote, value);
      shareableMappingCache.set(value, adapted);
      shareableMappingCache.set(adapted);
      return adapted;
    }
  }
  return ReanimatedModule.makeShareableClone(value, shouldPersistRemote, undefined);
}
